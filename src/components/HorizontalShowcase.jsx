    ...
    <section ref={containerRef} className="relative w-full bg-black text-white">
      <div ref={trackRef} className="horizontal-wrapper flex will-change-transform">
        ...
        <article className="h-slide shrink-0 w-[100vw] md:w-[70vw] xl:w-[60vw] h-[80vh] md:h-[90vh] p-8 md:p-12 flex items-end bg-neutral-900 border-r border-white/10 relative overflow-hidden">
          ...
          <div className="skewable relative z-10">
            <h3 className="text-3xl md:text-5xl font-black tracking-tight">Featured Reel</h3>
            <p className="mt-3 text-white/70 max-w-md">A montage of high-impact commercial pieces, product films, and interactive brand moments.</p>
          </div>
        </article>
        ...
        <article className="h-slide shrink-0 w-[100vw] md:w-[70vw] xl:w-[60vw] h-[80vh] md:h-[90vh] p-8 md:p-12 flex items-end bg-neutral-900 border-r border-white/10 relative overflow-hidden">
          ...
          <div className="skewable relative z-10">
            ...
            <p className="mt-3 text-white/70 max-w-md">Dynamic camera moves, glossy surfaces, and precision lighting designed for speed.</p>
          </div>
        </article>
        ...
        <article className="h-slide shrink-0 w-[100vw] md:w-[70vw] xl:w-[60vw] h-[80vh] md:h-[90vh] p-8 md:p-12 flex items-end bg-neutral-900 border-r border-white/10 relative overflow-hidden">
          ...
          <div className="skewable relative z-10">
            ...
            <p className="mt-3 text-white/70 max-w-md">Macro textures and tactile choreography that elevate the physical into the iconic.</p>
          </div>
        </article>
        ...
        <article className="h-slide shrink-0 w-[100vw] md:w-[70vw] xl:w-[60vw] h-[80vh] md:h-[90vh] p-8 md:p-12 flex items-end bg-neutral-900 relative overflow-hidden">
          ...
          <div className="skewable relative z-10">
            ...
            <p className="mt-3 text-white/70 max-w-md">Real-time experiences and websites with filmic motion and narrative cadence.</p>
          </div>
        </article>
      </div>
    </section>
